...
const X = 1e3,
    ...
    Ue = "start",
    De = "visibilitychange";
var Lt = Ct({ name: "VueCountdown", props: { autoStart: { type: Boolean, default: !0 }, emitEvents: { type: Boolean, default: !0 }, interval: { type: Number, default: 1e3, validator: e => e >= 0 }, now: { type: Function, default: () => Date.now() }, tag: { type: String, default: "span" }, time: { type: Number, default: 0, validator: e => e >= 0 }, transform: { type: Function, default: e => e } }, emits: [Pe, Be, Ie, Ue], data() { return { counting: !1, endTime: 0, totalMilliseconds: 0, requestId: 0 } }, computed: { days() { return Math.floor(this.totalMilliseconds / Le) }, hours() { return Math.floor(this.totalMilliseconds % Le / G) }, minutes() { return Math.floor(this.totalMilliseconds % G / K) }, seconds() { return Math.floor(this.totalMilliseconds % K / X) }, milliseconds() { return Math.floor(this.totalMilliseconds % X) }, totalDays() { return this.days }, totalHours() { return Math.floor(this.totalMilliseconds / G) }, totalMinutes() { return Math.floor(this.totalMilliseconds / K) }, totalSeconds() { return Math.floor(this.totalMilliseconds / X) } }, watch: { $props: { deep: !0, immediate: !0, handler() { this.totalMilliseconds = this.time, this.endTime = this.now() + this.time, this.autoStart && this.start() } } }, mounted() { document.addEventListener(De, this.handleVisibilityChange) }, beforeUnmount() { document.removeEventListener(De, this.handleVisibilityChange), this.pause() }, methods: { start() { this.counting || (this.counting = !0, this.emitEvents && this.$emit(Ue), document.visibilityState === "visible" && this.continue()) }, continue () { if (!this.counting) return; const e = Math.min(this.totalMilliseconds, this.interval); if (e > 0) { let t, n; const s = i => { t || (t = i), n || (n = i); const u = i - t;
                        u >= e || u + (i - n) / 2 >= e ? this.progress() : this.requestId = requestAnimationFrame(s), n = i };
                    this.requestId = requestAnimationFrame(s) } else this.end() }, pause() { cancelAnimationFrame(this.requestId) }, progress() {!this.counting || (this.totalMilliseconds -= this.interval, this.emitEvents && this.totalMilliseconds > 0 && this.$emit(Ie, { days: this.days, hours: this.hours, minutes: this.minutes, seconds: this.seconds, milliseconds: this.milliseconds, totalDays: this.totalDays, totalHours: this.totalHours, totalMinutes: this.totalMinutes, totalSeconds: this.totalSeconds, totalMilliseconds: this.totalMilliseconds }), this.continue()) }, abort() {!this.counting || (this.pause(), this.counting = !1, this.emitEvents && this.$emit(Pe)) }, end() {!this.counting || (this.pause(), this.totalMilliseconds = 0, this.counting = !1, this.emitEvents && this.$emit(Be)) }, update() { this.counting && (this.totalMilliseconds = Math.max(0, this.endTime - this.now())) }, handleVisibilityChange() { switch (document.visibilityState) {
                    case "visible":
                        this.update(), this.continue(); break;
                    case "hidden":
                        this.pause(); break } } }, render() { return St(this.tag, this.$slots.default ? [this.$slots.default(this.transform({ days: this.days, hours: this.hours, minutes: this.minutes, seconds: this.seconds, milliseconds: this.milliseconds, totalDays: this.totalDays, totalHours: this.totalHours, totalMinutes: this.totalMinutes, totalSeconds: this.totalSeconds, totalMilliseconds: this.totalMilliseconds }))] : void 0) } }),
    dt = { exports: {} },
    Te = { exports: {} },
...
function Me(e, t) { if (!(e === null || typeof e > "u"))
...
function Ae() { var e = {};
    ...
    function t(i, u) { Y(e[u]) && Y(i) ? e[u] = Ae(e[u], i) : Y(i) ? e[u] = Ae({}, i) : Re(i) ? e[u] = i.slice() : e[u] = i } for (var n = 0, s = arguments.length; n < s; n++) Me(arguments[n], t); return e }
...
var _t = function(t, n, s) { if (!n) return t; var i; if (s) i = s(n);
        else if (U.isURLSearchParams(n)) i = n.toString();
        else { var u = [];
            U.forEach(n, function(f, r) { f === null || typeof f > "u" || (U.isArray(f) ? r = r + "[]" : f = [f], U.forEach(f, function(l) { U.isDate(l) ? l = l.toISOString() : U.isObject(l) && (l = JSON.stringify(l)), u.push(He(r) + "=" + He(l)) })) }), i = u.join("&") } if (i) { var c = t.indexOf("#");
            c !== -1 && (t = t.slice(0, c)), t += (t.indexOf("?") === -1 ? "?" : "&") + i } return t },
    Yt = x;
...
function pt() { if (Fe) return le;
    Fe = 1; var e = vt; return le = function(n, s, i, u, c) { var o = new Error(n); return e(o, s, i, u, c) }, le }
var de, Je;

function tn() { if (Je) return de;
    Je = 1; var e = pt(); return de = function(n, s, i) { var u = i.config.validateStatus;!i.status || !u || u(i.status) ? n(i) : s(e("Request failed with status code " + i.status, i.config, null, i.request, i)) }, de }
var ce, ze;

function nn() { if (ze) return ce;
    ze = 1; var e = x; return ce = e.isStandardBrowserEnv() ? function() { return { write: function(s, i, u, c, o, f) { var r = [];
                r.push(s + "=" + encodeURIComponent(i)), e.isNumber(u) && r.push("expires=" + new Date(u).toGMTString()), e.isString(c) && r.push("path=" + c), e.isString(o) && r.push("domain=" + o), f === !0 && r.push("secure"), document.cookie = r.join("; ") }, read: function(s) { var i = document.cookie.match(new RegExp("(^|;\\s*)(" + s + ")=([^;]*)")); return i ? decodeURIComponent(i[3]) : null }, remove: function(s) { this.write(s, "", Date.now() - 864e5) } } }() : function() { return { write: function() {}, read: function() { return null }, remove: function() {} } }(), ce }
var fe, Ve;
...
function rn() { if (We) return me;
    We = 1; var e = sn(),
        t = an(); return me = function(s, i) { return s && !e(i) ? t(s, i) : i }, me }
var _e, Xe;

function on() { if (Xe) return _e;
    Xe = 1; var e = x,
        t = ["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]; return _e = function(s) { var i = {},
            u, c, o; return s && e.forEach(s.split(`
`), function(r) { if (o = r.indexOf(":"), u = e.trim(r.substr(0, o)).toLowerCase(), c = e.trim(r.substr(o + 1)), u) { if (i[u] && t.indexOf(u) >= 0) return;
                u === "set-cookie" ? i[u] = (i[u] ? i[u] : []).concat([c]) : i[u] = i[u] ? i[u] + ", " + c : c } }), i }, _e }
var ve, Ke;

function un() { if (Ke) return ve;
    Ke = 1; var e = x; return ve = e.isStandardBrowserEnv() ? function() { var n = /(msie|trident)/i.test(navigator.userAgent),
            s = document.createElement("a"),
            i;

        function u(c) { var o = c; return n && (s.setAttribute("href", o), o = s.href), s.setAttribute("href", o), { href: s.href, protocol: s.protocol ? s.protocol.replace(/:$/, "") : "", host: s.host, search: s.search ? s.search.replace(/^\?/, "") : "", hash: s.hash ? s.hash.replace(/^#/, "") : "", hostname: s.hostname, port: s.port, pathname: s.pathname.charAt(0) === "/" ? s.pathname : "/" + s.pathname } } return i = u(window.location.href),
            function(o) { var f = e.isString(o) ? u(o) : o; return f.protocol === i.protocol && f.host === i.host } }() : function() { return function() { return !0 } }(), ve }
var pe, Ge;

function ee() { if (Ge) return pe;
    Ge = 1;

    function e(t) { this.message = t } return e.prototype.toString = function() { return "Cancel" + (this.message ? ": " + this.message : "") }, e.prototype.__CANCEL__ = !0, pe = e, pe }
var be, Ye;

function Ze() { if (Ye) return be;
    Ye = 1; var e = x,
        t = tn(),
        n = nn(),
        s = _t,
        ...
        o = pt(),
        f = te(),
        r = ee(); return be = function(l) { return new Promise(function(w, C) { var N = l.data,
                L = l.headers,
                P = l.responseType,
                R;

            function J() { l.cancelToken && l.cancelToken.unsubscribe(R), l.signal && l.signal.removeEventListener("abort", R) }
            e.isFormData(N) && delete L["Content-Type"]; var m = new XMLHttpRequest; if (l.auth) { var se = l.auth.username || "",
                    ie = l.auth.password ? unescape(encodeURIComponent(l.auth.password)) : "";
                L.Authorization = "Basic " + btoa(se + ":" + ie) } var z = i(l.baseURL, l.url);
            m.open(l.method.toUpperCase(), s(z, l.params, l.paramsSerializer), !0), m.timeout = l.timeout;

            function V() { if (!!m) { var d = "getAllResponseHeaders" in m ? u(m.getAllResponseHeaders()) : null,
                        _ = !P || P === "text" || P === "json" ? m.responseText : m.response,
                        v = { data: _, status: m.status, statusText: m.statusText, headers: d, config: l, request: m };
                    t(function(T) { w(T), J() }, function(T) { C(T), J() }, v), m = null } } if ("onloadend" in m ? m.onloadend = V : m.onreadystatechange = function() {!m || m.readyState !== 4 || m.status === 0 && !(m.responseURL && m.responseURL.indexOf("file:") === 0) || setTimeout(V) }, m.onabort = function() {!m || (C(o("Request aborted", l, "ECONNABORTED", m)), m = null) }, m.onerror = function() { C(o("Network Error", l, null, m)), m = null }, m.ontimeout = function() { var _ = l.timeout ? "timeout of " + l.timeout + "ms exceeded" : "timeout exceeded",
                        v = l.transitional || f.transitional;
                    l.timeoutErrorMessage && (_ = l.timeoutErrorMessage), C(o(_, l, v.clarifyTimeoutError ? "ETIMEDOUT" : "ECONNABORTED", m)), m = null }, e.isStandardBrowserEnv()) { var ae = (l.withCredentials || c(z)) && l.xsrfCookieName ? n.read(l.xsrfCookieName) : void 0;
                ae && (L[l.xsrfHeaderName] = ae) } "setRequestHeader" in m && e.forEach(L, function(_, v) { typeof N > "u" && v.toLowerCase() === "content-type" ? delete L[v] : m.setRequestHeader(v, _) }), e.isUndefined(l.withCredentials) || (m.withCredentials = !!l.withCredentials), P && P !== "json" && (m.responseType = l.responseType), typeof l.onDownloadProgress == "function" && m.addEventListener("progress", l.onDownloadProgress), typeof l.onUploadProgress == "function" && m.upload && m.upload.addEventListener("progress", l.onUploadProgress), (l.cancelToken || l.signal) && (R = function(d) {!m || (C(!d || d && d.type ? new r("canceled") : d), m.abort(), m = null) }, l.cancelToken && l.cancelToken.subscribe(R), l.signal && (l.signal.aborted ? R() : l.signal.addEventListener("abort", R))), N || (N = null), m.send(N) }) }, be }
var ye, $e;

function te() { if ($e) return ye;
    $e = 1; var e = x,
        t = en,
        n = vt,
    ...
    function c(f, r, h) { if (e.isString(f)) try { return (r || JSON.parse)(f), e.trim(f) } catch (l) { if (l.name !== "SyntaxError") throw l }
        return (h || JSON.stringify)(f) } var o = { transitional: { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 }, adapter: u(), transformRequest: [function(r, h) { return t(h, "Accept"), t(h, "Content-Type"), e.isFormData(r) || e.isArrayBuffer(r) || e.isBuffer(r) || e.isStream(r) || e.isFile(r) || e.isBlob(r) ? r : e.isArrayBufferView(r) ? r.buffer : e.isURLSearchParams(r) ? (i(h, "application/x-www-form-urlencoded;charset=utf-8"), r.toString()) : e.isObject(r) || h && h["Content-Type"] === "application/json" ? (i(h, "application/json"), c(r)) : r }], transformResponse: [function(r) { var h = this.transitional || o.transitional,
                l = h && h.silentJSONParsing,
                q = h && h.forcedJSONParsing,
                w = !l && this.responseType === "json"; if (w || q && e.isString(r) && r.length) try { return JSON.parse(r) } catch (C) { if (w) throw C.name === "SyntaxError" ? n(C, this, "E_JSON_PARSE") : C }
            return r }], timeout: 0, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN", maxContentLength: -1, maxBodyLength: -1, validateStatus: function(r) { return r >= 200 && r < 300 }, headers: { common: { Accept: "application/json, text/plain, */*" } } }; return e.forEach(["delete", "get", "head"], function(r) { o.headers[r] = {} }), e.forEach(["post", "put", "patch"], function(r) { o.headers[r] = e.merge(s) }), ye = o, ye }
var ln = x,
    dn = te(),
...
var _n = function(t) { xe(t), t.headers = t.headers || {}, t.data = we.call(t, t.data, t.headers, t.transformRequest), t.headers = tt.merge(t.headers.common || {}, t.headers[t.method] || {}, t.headers), tt.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function(i) { delete t.headers[i] }); var n = t.adapter || hn.adapter; return n(t).then(function(i) { return xe(t), i.data = we.call(t, i.data, i.headers, t.transformResponse), i }, function(i) { return fn(i) || (xe(t), i && i.response && (i.response.data = we.call(t, i.response.data, i.response.headers, t.transformResponse))), Promise.reject(i) }) },
    ...
    yt = function(t, n) { n = n || {}; var s = {};
        ...
        function f(h) { if (h in n) return i(t[h], n[h]); if (h in t) return i(void 0, t[h]) } var r = { url: c, method: c, data: c, baseURL: o, transformRequest: o, transformResponse: o, paramsSerializer: o, timeout: o, timeoutMessage: o, withCredentials: o, adapter: o, responseType: o, xsrfCookieName: o, xsrfHeaderName: o, onUploadProgress: o, onDownloadProgress: o, decompress: o, maxContentLength: o, maxBodyLength: o, transport: o, httpAgent: o, httpsAgent: o, cancelToken: o, socketPath: o, responseEncoding: o, validateStatus: f }; return k.forEach(Object.keys(t).concat(Object.keys(n)), function(l) { var q = r[l] || u,
                w = q(l);
            k.isUndefined(w) && q !== f || (s[l] = w) }), s },
    qe, nt;
...
je.transitional = function(t, n, s) {
    function i(u, c) { return "[Axios v" + vn + "] Transitional option '" + u + "'" + c + (s ? ". " + s : "") } return function(u, c, o) { if (t === !1) throw new Error(i(c, " has been removed" + (n ? " in " + n : ""))); return n && !st[c] && (st[c] = !0, console.warn(i(c, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(u, c, o) : !0 } };

function pn(e, t, n) { if (typeof e != "object") throw new TypeError("options must be an object"); for (var s = Object.keys(e), i = s.length; i-- > 0;) { var u = s[i],
            c = t[u]; if (c) { var o = e[u],
                f = o === void 0 || c(o, u, e); if (f !== !0) throw new TypeError("option " + u + " must be " + f); continue } if (n !== !0) throw Error("Unknown option " + u) } }
...
F.prototype.request = function(t, n) { if (typeof t == "string" ? (n = n || {}, n.url = t) : n = t || {}, !n.url) throw new Error("Provided config url is not valid");
    n = ne(this.defaults, n), n.method ? n.method = n.method.toLowerCase() : this.defaults.method ? n.method = this.defaults.method.toLowerCase() : n.method = "get"; var s = n.transitional;
    s !== void 0 && xt.assertOptions(s, { silentJSONParsing: D.transitional(D.boolean), forcedJSONParsing: D.transitional(D.boolean), clarifyTimeoutError: D.transitional(D.boolean) }, !1); var i = [],
        u = !0;
    this.interceptors.request.forEach(function(w) { typeof w.runWhen == "function" && w.runWhen(n) === !1 || (u = u && w.synchronous, i.unshift(w.fulfilled, w.rejected)) }); var c = [];
    this.interceptors.response.forEach(function(w) { c.push(w.fulfilled, w.rejected) }); var o; if (!u) { var f = [at, void 0]; for (Array.prototype.unshift.apply(f, i), f = f.concat(c), o = Promise.resolve(n); f.length;) o = o.then(f.shift(), f.shift()); return o } for (var r = n; i.length;) { var h = i.shift(),
            l = i.shift(); try { r = h(r) } catch (q) { l(q); break } } try { o = at(r) } catch (q) { return Promise.reject(q) } for (; c.length;) o = o.then(c.shift(), c.shift()); return o };
...
function wn() { if (rt) return Ee;
    rt = 1; var e = ee();

    function t(n) { if (typeof n != "function") throw new TypeError("executor must be a function."); var s;
        this.promise = new Promise(function(c) { s = c }); var i = this;
        this.promise.then(function(u) { if (!!i._listeners) { var c, o = i._listeners.length; for (c = 0; c < o; c++) i._listeners[c](u);
                i._listeners = null } }), this.promise.then = function(u) { var c, o = new Promise(function(f) { i.subscribe(f), c = f }).then(u); return o.cancel = function() { i.unsubscribe(c) }, o }, n(function(c) { i.reason || (i.reason = new e(c), s(i.reason)) }) } return t.prototype.throwIfRequested = function() { if (this.reason) throw this.reason }, t.prototype.subscribe = function(s) { if (this.reason) { s(this.reason); return }
        this._listeners ? this._listeners.push(s) : this._listeners = [s] }, t.prototype.unsubscribe = function(s) { if (!!this._listeners) { var i = this._listeners.indexOf(s);
            i !== -1 && this._listeners.splice(i, 1) } }, t.source = function() { var s, i = new t(function(c) { s = c }); return { token: i, cancel: s } }, Ee = t, Ee }
var ke, ot;

function xn() { return ot || (ot = 1, ke = function(t) { return function(s) { return t.apply(null, s) } }), ke }
var Ce, ut;

function qn() { if (ut) return Ce;
    ut = 1; var e = x; return Ce = function(n) { return e.isObject(n) && n.isAxiosError === !0 }, Ce }
var lt = x,
    En = ct,
    Z = gn,
    kn = yt,
...
function qt(e) { var t = new Z(e),
        n = En(Z.prototype.request, t); return lt.extend(n, Z.prototype, t), lt.extend(n, t), n.create = function(i) { return qt(kn(e, i)) }, n }
var A = qt(Cn);
A.Axios = Z;
A.Cancel = ee();
A.CancelToken = wn();
...
const Sn = { layout: Et, components: { Head: Tt, Link: Rt, VueCountdown: Lt, Editor: kt }, props: { id: Number, page: Number, exam_group: Object, all_questions: Array, question_answered: Number, question_active: Object, answer_order: Array, duration: Object }, setup(e) { let t = ["A", "B", "C", "D", "E"]; const n = { a: "\u3042", i: "\u3044", u: "\u3046", e: "\u3048", o: "\u304A", ka: "\u304B", ki: "\u304D", ku: "\u304F", ke: "\u3051", ko: "\u3053", ga: "\u304C", gi: "\u304E", gu: "\u3050", ge: "\u3052", go: "\u3054", sa: "\u3055", shi: "\u3057", su: "\u3059", se: "\u305B", so: "\u305D", za: "\u3056", ji: "\u3058", zu: "\u305A", ze: "\u305C", zo: "\u305E", ta: "\u305F", chi: "\u3061", tsu: "\u3064", te: "\u3066", to: "\u3068", da: "\u3060", di: "\u3062", du: "\u3065", de: "\u3067", do: "\u3069", na: "\u306A", ni: "\u306B", nu: "\u306C", ne: "\u306D", no: "\u306E", ha: "\u306F", hi: "\u3072", fu: "\u3075", he: "\u3078", ho: "\u307B", ba: "\u3070", bi: "\u3073", bu: "\u3076", be: "\u3079", bo: "\u307C", pa: "\u3071", pi: "\u3074", pu: "\u3077", pe: "\u307A", po: "\u307D", ma: "\u307E", mi: "\u307F", mu: "\u3080", me: "\u3081", mo: "\u3082", ya: "\u3084", yu: "\u3086", yo: "\u3088", ra: "\u3089", ri: "\u308A", ru: "\u308B", re: "\u308C", ro: "\u308D", wa: "\u308F", wi: "\u3090", we: "\u3091", wo: "\u3092", n: "\u3093", kya: "\u304D\u3083", kyu: "\u304D\u3085", kyo: "\u304D\u3087", gya: "\u304E\u3083", gyu: "\u304E\u3085", gyo: "\u304E\u3087", sha: "\u3057\u3083", shu: "\u3057\u3085", sho: "\u3057\u3087", ja: "\u3058\u3083", ju: "\u3058\u3085", jo: "\u3058\u3087", cha: "\u3061\u3083", chu: "\u3061\u3085", cho: "\u3061\u3087", nya: "\u306B\u3083", nyu: "\u306B\u3085", nyo: "\u306B\u3087", hya: "\u3072\u3083", hyu: "\u3072\u3085", hyo: "\u3072\u3087", bya: "\u3073\u3083", byu: "\u3073\u3085", byo: "\u3073\u3087", pya: "\u3074\u3083", pyu: "\u3074\u3085", pyo: "\u3074\u3087", mya: "\u307F\u3083", myu: "\u307F\u3085", myo: "\u307F\u3087", rya: "\u308A\u3083", ryu: "\u308A\u3085", ryo: "\u308A\u3087", si: "\u3057", ti: "\u3061", tu: "\u3064", zi: "\u3058", nn: "\u3093", xya: "\u3083", xyu: "\u3085", xyo: "\u3087", xa: "\u3041", xi: "\u3043", xu: "\u3045", xe: "\u3047", xo: "\u3049", xtu: "\u3063", xtsu: "\u3063", ltu: "\u3063", ltsu: "\u3063", xwa: "\u308E", xke: "\u3096", xka: "\u3095" },
                s = d => { let _ = "",
                        v = 0; for (; v < d.length;) { let M = !1; for (let T = 4; T >= 1; T--)
                            if (v + T <= d.length) { const Oe = d.substring(v, v + T).toLowerCase(); if (n[Oe]) { _ += n[Oe], v += T, M = !0; break } }
                        M || (_ += d[v], v++) } return _ },
                i = (d, _) => { const v = _.selection.getBookmark(),
                        M = s(d);
                    M !== d ? (r.value = M, _.setContent(M), setTimeout(() => { _.selection.moveToBookmark(v) }, 10)) : r.value = d },
                u = { height: 300, menubar: !1, plugins: ["advlist", "autolink", "lists", "link", "image", "charmap", "anchor", "searchreplace", "visualblocks", "code", "fullscreen", "insertdatetime", "media", "table", "preview", "help", "wordcount"], toolbar: "undo redo | blocks | bold italic forecolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | help", content_style: "body { font-family: Arial, sans-serif; font-size: 14px; }", setup: d => { d.on("input", _ => { const v = d.getContent({ format: "text" });
                            i(v, d) }), d.on("paste", _ => { setTimeout(() => { const v = d.getContent({ format: "text" });
                                i(v, d) }, 10) }) } },
                c = I(0),
                o = I(e.duration.duration),
                f = I([]),
                r = I("");
            Mt(() => { if (e.question_active)
                    if (e.question_active.question.question_type === "multiple") try { const d = JSON.parse(e.question_active.selected_answers || "[]");
                        f.value = Array.isArray(d) ? d : [] } catch (d) { f.value = [], console.error("Error parsing selected answers:", d) } else e.question_active.question.question_type === "essay" && (r.value = e.question_active.essay_answer || "") }), jt(() => e.question_active, d => { if (d && d.question.question_type === "essay") r.value = d.essay_answer || "";
                else if (d && d.question.question_type === "multiple") try { const _ = JSON.parse(d.selected_answers || "[]");
                    f.value = Array.isArray(_) ? _ : [] } catch { f.value = [] } }); const h = d => { switch (d) {
                        case "single":
                ...
                P = d => { if (d.question.question_type === "single") return d.answer !== 0; if (d.question.question_type === "multiple") try { const _ = JSON.parse(d.selected_answers || "[]"); return Array.isArray(_) && _.length > 0 } catch { return !1 } else if (d.question.question_type === "essay") return d.essay_answer && d.essay_answer.trim() !== "";
                    return !1 },
