<template>
    ...
    <Head>
        <title>Edit Tutor - Aplikasi Ujian Online</title>
    </Head>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user-tie"></i> Edit Tutor</h5>
                        <hr>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="password" class="form-control"
                                            placeholder="Masukkan Password (kosongkan jika tidak ingin diubah)"
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            Inertia.put(`/admin/tutors/${props.tutor.id}`, {
                nip: form.nip,
                name: form.name,
                email: form.email,
                phone: form.phone,
